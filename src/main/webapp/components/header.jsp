    ...
    <div class="header-nav-bar">
        <div class="container">
            <nav class="header-nav">
                <ul>
                    <li><a href="<%= request.getContextPath() %>/index.jsp" class="active">Trang Chủ</a>
                    </li>
                            ...
                            <div class="mega-menu-grid">
                                <div class="mega-menu-column">
                                    ...
                                    <ul class="mega-menu-list">
                                        ...
                                        <li><a href="<%= request.getContextPath() %>/store.jsp"
                                            ...
                                            Vang Hồng</a></li>
                                        <li><a href="<%= request.getContextPath() %>/store.jsp"
                                               class="mega-menu-link">Sâm
                                            Panh / Vang Nổ</a></li>
                                        <li><a href="<%= request.getContextPath() %>/store.jsp"
                                               class="mega-menu-link">Rượu
                                            Vang Ngọt</a></li>
                                        <li><a href="<%= request.getContextPath() %>/store.jsp"
                                               class="mega-menu-link">Cognac
                                            & Rượu Mạnh</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="mega-menu-column">
                                    ...
                                    <ul class="mega-menu-list">
                                        <li><a href="<%= request.getContextPath() %>/store.jsp"
                                            ...
                                            CORBIN</a></li>
                                        <li><a href="<%= request.getContextPath() %>/store.jsp"
                                               class="mega-menu-link">TENUTA
                                            LUCE</a></li>
                                        <li><a href="<%= request.getContextPath() %>/store.jsp"
                                               class="mega-menu-link">MAISON
                                            LOUIS LATOUR</a></li>
                                        <li><a href="<%= request.getContextPath() %>/store.jsp"
                                               class="mega-menu-link">Domaine
                                            Faiveley</a></li>
                                        <li><a href="<%= request.getContextPath() %>/store.jsp"
                                               class="mega-menu-link">BODEGAS
                                            MUGA</a></li>
                                        <li><a href="<%= request.getContextPath() %>/store.jsp"
                                ...
                                <div class="mega-menu-column">
                                    ...
                                    <ul class="mega-menu-list">
                                        ...
                                        <li><a href="#" class="mega-menu-link">Marlborough (New Zealand)</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
