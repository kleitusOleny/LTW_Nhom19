                ...
                <form id="login-form" action="${pageContext.request.contextPath}/login" method="POST">
                    ...
                    <div class="password-input">
                        ...
                        <div class="input-wrapper">
                            <input type="password" id="password" name="password" placeholder="Nhập mật khẩu hiện có"
                                class="${not empty inputError ? 'input-error' : ''}" required>
                            <span id="eyeIcon">
                    ...
                    <%-- Đăng nhập bằng google --%>
                        <div class="social-login">
                            ...
                            <div id="g_id_onload"
                                ...
                                data-login_uri="${pageContext.request.contextPath}/LoginGoogle${not empty param.redirect ? '?redirect='.concat(param.redirect) : ''}"
            ...
            <div class="modal-content-question">
                ...
                <div class="group-p">
                    <p>
                        ...
                        Theo quy định về kinh doanh đồ uống có cồn, chúng tôi cần xác minh người mua đã đủ độ tuổi hợp
                        pháp.
                    </p>
                    <p>
                        <ion-icon name="shield-checkmark-outline"></ion-icon>
                        Việc đăng nhập cũng giúp bảo mật thông tin đơn hàng, thêm khuyến mãi cho cá nhân và đảm bảo
                        quyền lợi
