...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/AdminPages/admin_css/manage_promotion_style.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/AdminPages/admin_css/create_order_style.css">
</head>
    ...
    <div class="dashboard-container">
        <nav class="dashboard-sidebar">
            <ul class="sidebar-items">
                ...
                <li><a href="${pageContext.request.contextPath}/admin/manage-orders" class="a-with-icon selected">
                ...
                <li><a href="${pageContext.request.contextPath}/admin/manage-promotions" class="a-with-icon">
            ...
            <main class="dashboard-main-content">
                ...
                <div class="page-header-box">
                    ...
                    <div class="header-right">
                        <a href="${pageContext.request.contextPath}/admin/manage-orders" class="btn-back">
                ...
                <div class="order-layout">
                    ...
                    <div class="products-section">
                        <div class="section-card">
                            ...
                            <!-- Form tìm kiếm -->
                            <form method="get" action="${pageContext.request.contextPath}/admin/create-order" class="search-filter-form">
                                <div class="search-box">
                                    <ion-icon name="search-outline"></ion-icon>
                                    <input type="text" name="keyword" placeholder="Tìm theo tên, mã sản phẩm..." 
                                           value="${keyword}">
                                    <button type="submit" class="btn-search">Tìm kiếm</button>
                                </div>
                                <div class="filter-tabs">
                                    <a href="${pageContext.request.contextPath}/admin/create-order?filterType=all" 
                                       class="filter-tab ${filterType == 'all' || filterType == null ? 'active' : ''}">Tất cả</a>
                                    <a href="${pageContext.request.contextPath}/admin/create-order?filterType=đỏ" 
                                       class="filter-tab ${filterType == 'đỏ' ? 'active' : ''}">Vang đỏ</a>
                                    <a href="${pageContext.request.contextPath}/admin/create-order?filterType=trắng" 
                                       class="filter-tab ${filterType == 'trắng' ? 'active' : ''}">Vang trắng</a>
                                    <a href="${pageContext.request.contextPath}/admin/create-order?filterType=hồng" 
                                       class="filter-tab ${filterType == 'hồng' ? 'active' : ''}">Vang hồng</a>
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <div class="product-footer">
                                                        <div class="price-stock">
                                                            <span class="price">
                                                                <fmt:formatNumber value="${p.price}" type="currency" currencySymbol="" maxFractionDigits="0"/>đ
                                                            </span>
                                                            <span class="stock">Còn ${p.quantity} chai</span>
                                                        </div>
                                                        <button type="button"
                    ...
                    <div class="order-sidebar">
                        ...
                        <!-- Form đặt hàng -->
                        <form id="orderForm" action="${pageContext.request.contextPath}/admin/submit-order" method="post">
                            <input type="hidden" name="cartData" id="cartDataInput">
                            
                            <!-- Thông tin khách hàng -->
                            <div class="section-card">
                                <div class="section-header">
                                    <h3><ion-icon name="person-outline"></ion-icon> Thông tin khách hàng</h3>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="customerAddress" id="customerAddress" rows="2" required
                            ...
                            <div class="section-card">
                                <div class="section-header">
                                    <h3><ion-icon name="wallet-outline"></ion-icon> Phương thức thanh toán</h3>
                                </div>
