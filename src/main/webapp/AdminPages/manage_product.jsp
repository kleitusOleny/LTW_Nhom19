        ...
        <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <body>
                                                    ...
                                                    <div class="cell-action">
                                                        ...
                                                        <form action="product-manager" method="POST" style="margin:0;">
                                                            ...
                                                            <button type="submit" class="delete btn"
                                                                onclick="return confirm('Xóa sản phẩm này?');">Xoá</button>
                                                        </form>
                                                    </div>
                                                </td>
                                            </tr>
                ...
                <%@ include file="/AdminPages/components/notify_modal.jsp" %>
                        ...
                        <div class="modal-content-form">
                            ...
                            <form id="add-product-form" action="product-manager" method="POST"
                                ...
                                <div class="form-actions">
                                    ...
                                    <button type="submit" class="btn btn-primary" id="btn-submit-form">Lưu Sản
                                        Phẩm</button>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="modal-overlay-notification" id="notification-account-modal">
                        <div class="modal-content-notification">
                            <div class="group-notification">
                                ...
                                <button class="modal-close" id="close-modal-btn8"><ion-icon
                                        name="close-outline"></ion-icon></button>
                            </div>
                            <div class="notification-empty-state"><ion-icon name="notifications-off-outline"></ion-icon>
                    ...
                    <div class="modal-overlay-avatar" id="avatar-account-modal">
                        <div class="modal-content-avatar">
                            <button class="modal-close2" id="close-modal-btn9"><ion-icon
                                    name="close-outline"></ion-icon></button>
                            <a href="${pageContext.request.contextPath}/home" class="btn-menu-item"><ion-icon
                                    name="person-circle-outline"></ion-icon><span>Trang người dùng</span></a>
                            <a href="${pageContext.request.contextPath}/logout" class="btn-menu-item"><ion-icon
                                    name="log-out-outline"></ion-icon><span>Đăng xuất</span></a>
                        </div>
                    </div>
