            ...
            <body>
                <div class="dashboard-container">
                    <nav class="dashboard-sidebar">
                        <ul class="sidebar-items">
                            <div class="group-avatar"><img src="<%= request.getContextPath() %>/assets/avatar.jpg"
                                    class="user-avatar" id="avatar-modal-btn" />
                                                ...
                                                <td>
                                                    <div class="cell-action">
                                                        <button class="edit btn"
                                                            onclick="editBanner(${b.id})">Sửa</button>
                ...
                <div class="modal-overlay-form" id="delete-confirm-modal" style="--modal-width: 450px;">
                    <div class="modal-content-form">
                        ...
                        <p class="modal-confirm-text">Bạn có chắc chắn muốn xóa Banner này không? Hành động này không
                            thể hoàn tác.</p>
