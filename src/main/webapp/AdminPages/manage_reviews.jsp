                        ...
                        <tbody>
                            <c:forEach items="${reviews}" var="r">
                                <tr class="reviews">
                                        ...
                                        <div class="star-display">
                                            <c:forEach begin="1" end="5" var="i">
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <ion-icon name="star-outline" class="star-empty"></ion-icon>
                                                    </c:otherwise>
                                                </c:choose>
                                            </c:forEach>
                                    ...
                                    <td class="cell-date">
                                        <fmt:parseDate value="${r.createAt}" pattern="yyyy-MM-dd'T'HH:mm" var="parsedDate" type="both" />
                                    ...
                                    <td class="cell-action">
                                        <button class="view btn" onclick="viewReview(${r.id}, '${r.userName}', '${r.productName}', ${r.star}, '${r.content}')">
                                        ...
                                        <c:choose>
                                            <c:when test="${r.deleted}">
                                                <button class="restore btn" onclick="confirmRestore(${r.id})">
    ...
    <div class="modal-overlay-deleteAll" id="deleteAll-review-modal">
        <div class="modal-content-deleteAll">
            ...
            <div class="group-button-action delete-all">
                ...
                <button type="submit" class="deleteAll-button" onclick="deleteSelectedReviews()">Xoá Tất Cả</button>
            </div>
        </div>
    </div>
            ...
            <form action="${pageContext.request.contextPath}/admin/update-review" method="post">
                ...
                <div class="edit-information-review">
                    ...
                    <div class="content-section">
                        ...
                        <textarea id="content_edit" name="content" rows="5" required>${reviewEdit.content}</textarea>
                    </div>
                </div>
                <div class="group-button-action section">
